...
<head>
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        let pageChangeV = function (){
            ...
            window.location.href="word?action=listAllWords&dict_source=2&curPage="+curPage+"&pageSize="+pageSize;
        }
...
<table border="1" id="data_table">
    ...
    <c:forEach items="${requestScope.wordList}" var="word">
        <tr>
            ...
            <td>${word.star}</td>
            <td>
                <button onclick="window.location.href='word?action=listWordDetail&dict_source=2&wid=${word.wid}'">详情</button>
